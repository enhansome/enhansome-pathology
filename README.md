...
* [TIA Toolbox](https://github.com/TissueImageAnalytics/tiatoolbox/) ⭐ 550 | 🐛 14 | 🌐 Python | 📅 2026-09-09 - Computational pathology toolbox that provides an end-to-end API for pathology image analysis.
...
* [GrandQC](https://github.com/cpath-ukk/grandqc/) ⭐ 118 | 🐛 27 | 🌐 Python | 📅 2025-12-27 - A comprehensive solution to quality control problem in digital pathology.
...
* [tifffile](https://github.com/cgohlke/tifffile/) ⭐ 665 | 🐛 1 | 🌐 Python | 📅 2026-09-08 - Read and write TIFF-like files using in bioimaging.
* [cuCIM](https://github.com/rapidsai/cucim/) ⭐ 467 | 🐛 165 | 🌐 Jupyter Notebook | 📅 2026-09-08 - NVIDIA's accelerated computer vision and image processing software library for multidimensional images.
* [Bio-Formats](https://github.com/ome/bioformats/) ⭐ 428 | 🐛 172 | 🌐 Java | 📅 2026-09-08 - Java software tool for reading and writing microscopy image using standardized, open formats.
...
* [LongViT](https://github.com/microsoft/torchscale/blob/main/examples/longvit/) ⭐ 3,141 | 🐛 40 | 🌐 Python | 📅 2024-04-11 - Vision Transformer that can process gigapixel images in an end-to-end manner.
...
* [StarDist](https://github.com/stardist/stardist/) ⭐ 1,261 | 🐛 70 | 🌐 Python | 📅 2026-02-14 - Object detection with star-convex shapes.
* [HoVer-Net](https://github.com/vqdang/hover_net/) ⭐ 745 | 🐛 68 | 🌐 Python | 📅 2023-10-27 - Simultaneous segmentation and classification of nuclei in multi-tissue histology images.
...
* [UNI](https://github.com/mahmoodlab/UNI/) ⭐ 773 | 🐛 32 | 🌐 Jupyter Notebook | 📅 2025-03-26 - General-purpose foundation model for computational pathology.
...
* [slim](https://github.com/ImagingDataCommons/slim/) ⭐ 166 | 🐛 73 | 🌐 TypeScript | 📅 2026-09-08 - Interoperable web-based slide microscopy viewer and annotation tool.
...
* [HistomicsUI](https://github.com/DigitalSlideArchive/HistomicsUI/) ⭐ 80 | 🐛 52 | 🌐 JavaScript | 📅 2026-09-08 - Web interface to visualize WSI and manage annotations.
...
* [stettler2022datasets](https://github.com/maduc7/Histopathology-Datasets/) ⭐ 571 | 🐛 8 | 📅 2026-03-06 - Resources of histopathology datasets.
