...
* [TIA Toolbox](https://github.com/TissueImageAnalytics/tiatoolbox/) ⭐ 545 | 🐛 19 | 🌐 Python | 📅 2026-08-12 - Computational pathology toolbox that provides an end-to-end API for pathology image analysis.
* [HistomicsTK](https://github.com/DigitalSlideArchive/HistomicsTK/) ⭐ 483 | 🐛 28 | 🌐 Python | 📅 2026-08-06 - Toolkit for the analysis of digital pathology images.
...
* [PathProfiler](https://github.com/MaryamHaghighat/PathProfiler/) ⭐ 44 | 🐛 2 | 🌐 Python | 📅 2024-01-04 - Quality assessment of histopathology WSI cohorts.
* [PatchSorter](https://github.com/choosehappy/PatchSorter/) ⭐ 36 | 🐛 16 | 🌐 JavaScript | 📅 2026-08-12 - A tool for rapidly labeling objects using deep learning feature embedding.
...
* [Bio-Formats](https://github.com/ome/bioformats/) ⭐ 425 | 🐛 175 | 🌐 Java | 📅 2026-08-11 - Java software tool for reading and writing microscopy image using standardized, open formats.
...
* [Trident](https://github.com/mahmoodlab/TRIDENT/) ⭐ 616 | 🐛 33 | 🌐 Python | 📅 2026-08-07 - Toolkit for large-scale WSI processing.
...
* [ENACT](https://github.com/Sanofi-Public/enact-pipeline/) ⭐ 82 | 🐛 9 | 🌐 Python | 📅 2026-02-10 - End-to-end analysis and cell type annotation for Visium HD slides.
* [DLUP](https://github.com/nki-ai/dlup/) ⭐ 30 | 🐛 0 | 🌐 Python | 📅 2026-08-09 - Deep learning utilities for pathology.
* [FlashDeconv](https://github.com/cafferychen777/flashdeconv/) ⭐ 24 | 🐛 0 | 🌐 Python | 📅 2026-06-30 - High-performance spatial transcriptomics deconvolution for cell type mapping using structure-preserving randomized sketching.
...
* [StarDist](https://github.com/stardist/stardist/) ⭐ 1,251 | 🐛 69 | 🌐 Python | 📅 2026-02-14 - Object detection with star-convex shapes.
* [HoVer-Net](https://github.com/vqdang/hover_net/) ⭐ 735 | 🐛 68 | 🌐 Python | 📅 2023-10-27 - Simultaneous segmentation and classification of nuclei in multi-tissue histology images.
...
* [ACMIL](https://github.com/dazhangyu123/ACMIL/) ⭐ 136 | 🐛 2 | 🌐 Python | 📅 2025-04-28 - WSI classification.
...
* [FrOoDo](https://github.com/MECLabTUDA/FrOoDo/) ⭐ 27 | 🐛 1 | 🌐 Jupyter Notebook | 📅 2023-05-15 - Framework for out of distribution detection.
...
* [Phikon](https://github.com/owkin/HistoSSLscaling/) ⭐ 172 | 🐛 4 | 🌐 Jupyter Notebook | 📅 2024-01-29 - Scaling self-supervised learning for histopathology with masked image modeling.
...
* [KEEP](https://github.com/MAGIC-AI4Med/KEEP/) ⭐ 67 | 🐛 0 | 🌐 Python | 📅 2026-04-17 - A Knowledge-enhanced pathology vision-language foundation model for cancer diagnosis.
...
* [jahanifar2023domain](https://github.com/mostafajahanifar/awesome-dg-cpath/) ⭐ 24 | 🐛 0 | 📅 2024-11-07 - Awesome domain generalization for computational pathology.
